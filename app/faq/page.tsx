...
const faqCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '初回または初月の手配手数料無料はありますか？',
        a: '新規のお客様向けに、初回または初月の手配手数料無料の案内を行う場合があります。ただし、商品代金、国際送料、関税、VAT/GST、梱包費、保険料、規制確認費用などの実費は別途となります。',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'HSコードは確定してもらえますか？',
        a: '商品情報をもとに確認を支援する場合はありますが、HSコードの最終確定は税関・通関業者等の判断が前提となります。用途、素材、成分、構造、販売国により判断が変わる場合があります。',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: '医薬品、食品、化粧品は送れますか？',
        a: '国、成分、用途、数量、販売目的か個人使用かにより規制が異なります。医薬品、食品、化粧品は事前確認が必要であり、必ず発送できるとは限りません。',
