...
const categories = [
  {
    code: 'A',
    title: '医薬品・医療関連品',
    items: ['医薬品', '医薬部外品', '医療機器', 'サプリメント', '成分確認が必要な商品'],
  ...
  },
  {
    code: 'E',
    title: '危険品・可燃物',
    items: ['スプレー缶', '液体', 'アルコール含有品', '塗料', '接着剤', '燃料', '高圧ガス'],
    note: '航空輸送・国際宅配便では制限が強い場合があります。事前確認が必要です。',
  },
  {
    code: 'F',
    title: '中古品・ブランド品',
    items: ['中古品', 'ブランド品', '時計', 'バッグ', '知的財産権に関わる商品', '真贋確認が必要な商品'],
  ...
  return (
    <>
      <section className="restricted-hero">
        ...
        <p className="section-body restricted-lead" lang="ja">
